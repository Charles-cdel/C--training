...
//=========================Inicio modulo de controle ---IF ELSE IF ELSE=============================
...
//=========================Inicio modulo de controle ---FOR=============================

var lista = new List <string> (){"Carlos", "curso", "Csharp"};
...
//=========================Inicio modulo de controle ---FOREACH=============================
...
foreach (var letra in "Carlos")
{
    Console.WriteLine(letra);
}
//=========================Inicio modulo de controle ---WHILR DO WHILE=============================

var i = 0; 

while (i < 10)//validação é executada primeiro
{
    Console.WriteLine(i);
    i++;
}
...
}while(j < 2); //primeiro executa e depois valida*/